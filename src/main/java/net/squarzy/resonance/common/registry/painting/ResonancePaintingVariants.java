package net.squarzy.resonance.common.registry.painting;
...
public class ResonancePaintingVariants {
    ...
    public static RegistryObject<PaintingVariant> PNEMIA = PAINTINGS.register("pnemia", () -> new PaintingVariant(80, 48));
