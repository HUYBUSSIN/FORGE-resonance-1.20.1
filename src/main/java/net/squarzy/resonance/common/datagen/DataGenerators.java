...
import net.squarzy.resonance.common.datagen.generators.tags.ResonanceDataVariantTagData;

import java.util.concurrent.CompletableFuture;

    @Mod.EventBusSubscriber(modid = Resonance.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
